      ...
      return `
        <div class="page-header animate-fade-in">
          <div class="breadcrumb">
            ...
            <span class="breadcrumb-current">Payroll Access</span>
          </div>
        </div>
        <div class="card text-center" style="max-width: 620px; margin: 40px auto; padding: 40px 24px;">
          <div style="width: 56px; height: 56px; border-radius: 50%; background: var(--danger-light); color: var(--danger); display: flex; align-items: center; justify-content: center; margin: 0 auto 16px;">
            <svg width="28" height="28" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
            </svg>
          </div>
          <h2 style="font-size: 1.35rem; font-weight: 800; color: var(--text-main); margin-bottom: 8px;">Access Restricted — HR &amp; Super Admin Only</h2>
          <p style="color: var(--text-secondary); margin-bottom: 24px; font-size: 0.92rem; line-height: 1.55;">
            Payroll, salary processing, and compensation structures are confidential and restricted strictly to <strong>HR Managers and Super Administrators</strong>.<br><br>
            If you need your official monthly salary slip or tax certificate, please submit a formal document request via the <strong>HR Helpdesk</strong>.
          </p>
          <div style="display: flex; gap: 12px; justify-content: center; flex-wrap: wrap;">
            ...
            <button class="btn btn-primary btn-sm" onclick="Router.navigate('requests'); setTimeout(() => { if (window.RequestsView) RequestsView.openNewRequestModal('SALARY_SLIP_REQUEST'); }, 150);">
              ...
              <span>Request Salary Slip in HR Requests</span>
            </button>
          </div>
        </div>
      `;
