...
const MasterAdminView = {
  ...
  CARDS: [
    {
      ...
      title: "Companies",
      description:
        "View, create and manage all companies in your organization.",
      category: "USER",
    ...
    },
    {
      ...
      title: "Branches",
      description:
        "View and manage company branches, locations and contact details.",
      category: "USER",
      categoryLabel: "USER RELATED",
      route: "admin",
      icon: `<svg width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>`,
    },
    {
      ...
      title: "User List",
      description:
        "View, edit and manage all user accounts, roles and branch access.",
      category: "USER",
      categoryLabel: "USER RELATED",
      route: "users",
    ...
    },
    {
      ...
      title: "User Types",
      description:
        "Define custom roles and assign module + page access per user type.",
      category: "USER",
      categoryLabel: "USER RELATED",
      route: "users",
    ...
    },
    {
      ...
      title: "User Access",
      description:
        "Override page access for individual users beyond their user type defaults.",
      category: "USER",
      categoryLabel: "USER RELATED",
      route: "security",
    ...
    },
    {
      ...
      title: "Geography",
      description:
        "Manage countries, states, districts, cities and areas for address forms.",
      category: "SETTINGS",
  ...
  async render() {
    ...
    if (this.activeFilter === "USER")
      list = list.filter((c) => c.category === "USER");
    if (this.activeFilter === "SETTINGS")
      list = list.filter((c) => c.category === "SETTINGS");
    if (this.activeFilter === "FAVOURITES")
      list = list.filter((c) => this.isBookmarked(c.id));
    ...
    const settingsCount = this.CARDS.filter(
      (c) => c.category === "SETTINGS",
    ).length;
  ...
  isBookmarked(id) {
    const list = JSON.parse(
      localStorage.getItem("diallo_admin_bookmarks") || "[]",
    );
