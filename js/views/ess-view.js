      ...
      <div class="card" style="margin-bottom: 24px; border: 1px solid var(--border-main);">
        <div class="card-header timecard-header">
          <div class="timecard-header-main">
            ...
            <div class="card-subtitle timecard-header-subtitle">Authenticated as <strong>${employee.fullName || employee.name}</strong> • ${employee.branchName || "EL207 Mahape, Navi Mumbai"}</div>
          </div>
          ...
          <div class="ess-terminal-layout">
            <div class="ess-terminal-timer-info">
              ...
              <div style="font-size: 0.8rem; color: var(--text-secondary); margin-top: 6px;" id="ess-geo-status">
                Office Premises Geofence: EL207, Mahape
              </div>
            ...
            <div class="ess-terminal-actions">
              <div class="timecard-action-grid">
                <button class="btn timecard-action-btn ${this.isShiftCompletedToday ? "btn-secondary disabled" : this.isPunchedIn ? "btn-secondary disabled" : "btn-primary"}" id="ess-punch-in-btn" onclick="ESSView.punchIn()" style="${this.isShiftCompletedToday ? "opacity: 0.55; cursor: not-allowed;" : this.isPunchedIn ? "opacity: 0.85; cursor: default; background: #f0fdf4; border-color: #86efac; color: #166534;" : "background: #16a34a; border-color: #16a34a; color: #ffffff;"}" ${this.isShiftCompletedToday || this.isPunchedIn ? "disabled" : ""}>
                ...
                <button class="btn timecard-action-btn ${this.isShiftCompletedToday ? "btn-secondary disabled" : this.isOnBreak ? "btn-warning" : "btn-secondary"}" id="ess-break-btn" onclick="ESSView.toggleBreak()" style="${this.isShiftCompletedToday ? "opacity: 0.55; cursor: not-allowed;" : !this.isOnBreak && this.isPunchedIn ? "color: #d97706; border-color: #fcd34d;" : ""}" ${this.isShiftCompletedToday ? "disabled" : ""}>
                  <svg width="17" height="17" fill="none" viewBox="0 0 24 24" stroke="currentColor">
